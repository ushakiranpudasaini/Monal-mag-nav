...
<div class="border-b bg-white">
 ...
 <div class="flex">
            ...
            <button  class=" topnav-btn cursor-pointer text-[#176ed3]  hover:text-[#3182e1] lg:block hidden">
						  <?php 
						   wp_nav_menu(
                                    array(
                                        'theme_location' => 'buttonmenu1',
                                        'menu_id'        => 'primary-menu',
                                    )
                                );
						  ?>
						  </button>
<button  class="cursor-pointer bg-[#176ed3] text-white hover:bg-[#368bed] px-4 py-2  rounded-md ml-4 topnav-btn lg:block hidden">
						  <?php 
						   wp_nav_menu(
                                    array(
