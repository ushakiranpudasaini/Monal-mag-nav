<!-- Nav 1  -->
<header class=" scroll-navbar md:fixed md:top-0 w-full  ">
    <div class="nav-container max-w-6xl bg-white border-b md:px-4 mx-auto">
            ...
            <div class="flex items-center justify-center lg:justify-between ">
                <div class="flex items-center">
                    <button class="absolute left-0 lg:block top-2/4 -translate-y-2/4 lg:relative lg:translate-y-0"
                        id="side-open-button">
                        <svg viewBox="0 0 20 20" class="inline-block w-6 h-6 text-gray-700" version="1.1"
...
<div class="flex items-center">
            <button class="absolute right-0 lg:relative edu-search lg:block top-2/4 -translate-y-2/4 lg:translate-y-0"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="text-gray-700 bi bi-search"
                    viewBox="0 0 16 16">
                    <path
