<!-- Nav 1  -->
<div class="border-b fixed top-0 z-10 bg-gray-50 w-full ">
    <div class="nav-container mx-auto">
        <div class=" flex justify-between items-center navbar ss-nav font-poppins">
                            ...
                            if (has_nav_menu('primary')) {
                                wp_nav_menu(
                                    array(
                                        ...
                                        'menu_class'        => 'nav-menu',
                                        'container_class' => 'navbar-links top-nav',
                                        'li_class' => "relative block text-sm font-medium text-[#000000] transition duration-300 border-b-2 border-white hover:border-gray-900"
                                    )
                                );
                            } else {
                                wp_nav_menu(
    ...
    <button class="ml-6 search-button absolute right-0 lg:relative edu-search lg:block top-[30%] -translate-y-2/4 lg:translate-y-0"
...
<?php endif; ?>
         <button  class=" custom-button cursor-pointer  px-4 py-2   ml-4 topnav-btn lg:block hidden">
						  <?php 
						   wp_nav_menu(
                                    array(
                                        'theme_location' => 'buttonmenu',
                                        'menu_id'        => 'primary-menu',
                                    )
                                );
						  ?>
