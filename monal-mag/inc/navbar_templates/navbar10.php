<div class="border-b bg-white">
    <div class="nav-container mx-auto px-2">
        <div class="relative flex items-center justify-between py-3 navbar  font-poppins">
        
             <button class="relative block mr-6" id="side-open-button">
...
<div class="flex items-center">
            ...
            if (get_theme_mod('display_title_tagline', true)) {
				?>
                <button  class="custom-buttons  cursor-pointer  px-4 py-2  rounded-md ml-4 topnav-btn md:block hidden">
						  <?php 
						   wp_nav_menu(
                                    array(
            ...
            <button class="edu-search" id="search-open-button">
...
<div class="border-t bg-white border-gray-200 ">
    <div class="nav-container mx-auto px-2  ss-nav">
        <div class="flex justify-center sm:border-0 navbar font-poppins">
            <?php
