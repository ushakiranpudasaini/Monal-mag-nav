...
<div class="bg-white">
    <div class="nav-container mx-auto px-2  ss-nav">
        <div class="flex justify-between items-center sm:border-0 navbar font-poppins">
        <button class="relative lg:hidden" id="side-open-button">
        ...
        <?php if (has_custom_logo()) { ?>
            ...
            <button  class=" custom-button cursor-pointer  px-4 py-2  rounded-md  ml-6 topnav-btn lg:block hidden">
						  <?php 
						   wp_nav_menu(
                                    array(
