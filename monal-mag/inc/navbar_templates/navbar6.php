<div class="border-b bg-white">
    <div class="nav-container mx-auto px-2">
        <div class="relative flex items-center justify-between py-3 navbar  font-poppins">
            <button class="relative " id="side-open-button">
...
<div class="flex items-center">
            ...
            <button class="search-button edu-search" id="search-open-button">
            ...
            if (get_theme_mod('display_title_tagline', true)) {
				?>
                <button  class="cursor-pointer custom-button  px-4 py-2  rounded-md ml-4 topnav-btn lg:block hidden">
						  <?php 
						   wp_nav_menu(
                                    array(
