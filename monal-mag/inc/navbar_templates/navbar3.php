...
<button style=" background-color:#3587E6; color:#ffffff; cursor:pointer;font-size:14px;border-radius:6px;padding:12px 18px 12px 18px;" class="ml-4 topnav-btn lg:block hidden">
						  <?php 
						   wp_nav_menu(
                                    array(
